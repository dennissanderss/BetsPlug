...
export const navLabels: Record<Locale, Record<NavKey, string>> = {
  ...
  sw: {
    ...
    methodology: "Mbinu",
    trackRecord: "Rekodi ya matokeo",
    pricing: "Bei",
    learnHub: "Kituo cha kujifunza",
    betTypes: "Aina za utabiri",
    faq: "Maswali",
    about: "Kuhusu",
    contact: "Mawasiliano",
    freeVsPaid: "Bure vs malipo",
    telegram: "Telegram",
    login: "Ingia",
    getFreePicks: "Pata utabiri bure",
    product: "Bidhaa",
    learn: "Jifunze",
    company: "Kampuni",
    leagues: "Ligi",
    ...
    terms: "Masharti",
    cookies: "Vidakuzi",
    responsibleGambling: "Mchezo wenye busara",
    cookieSettings: "Mipangilio ya vidakuzi",
    viewAllLeagues: "Tazama ligi zote",
    premierLeague: "Premier League",
    laLiga: "La Liga",
    bundesliga: "Bundesliga",
    serieA: "Serie A",
