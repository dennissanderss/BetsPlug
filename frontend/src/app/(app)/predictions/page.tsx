      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <p className="mt-1 text-xs leading-relaxed text-slate-400">
            These predictions are generated by machine learning models for analytical and educational
            purposes only. They are{" "}
            <span className="font-semibold text-slate-300">not financial advice</span> and should not
            be used for gambling or wagering decisions. Past model accuracy does not guarantee future
            performance. Always gamble responsibly and within your means.
          </p>
        </div>
      </div>
    </div>
