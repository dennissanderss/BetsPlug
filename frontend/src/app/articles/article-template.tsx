        ...
        <article className="mx-auto w-full max-w-3xl px-4 sm:px-6">
          ...
          >
            ...
            <div className="mt-5 flex flex-wrap items-center gap-x-4 gap-y-2 text-xs text-slate-500">
              <span>
                {t("articles.byline")} <span className="text-slate-300">{article.author}</span>
              </span>
          ...
          {/* ── Inline promo banner (subtle but noticeable) ── */}
          <InlinePromoBanner />
...
function InlinePromoBanner() {
  ...
  return (
    <motion.aside
      ...
      transition={{ duration: 0.7, ease: [0.16, 1, 0.3, 1] }}
      className="relative my-14 overflow-hidden rounded-3xl border border-green-500/25 bg-gradient-to-br from-green-500/[0.08] via-emerald-500/[0.03] to-transparent p-6 backdrop-blur-xl sm:p-8"
    >
      {/* Subtle glow */}
