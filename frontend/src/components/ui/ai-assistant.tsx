    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div className="relative mx-auto flex h-[90vh] w-full max-w-xl flex-col overflow-hidden rounded-t-3xl border border-green-500/20 bg-gradient-to-br from-[#0a1220] via-[#0b1624] to-[#081019] shadow-2xl shadow-green-500/10 sm:h-[640px] sm:rounded-3xl">
              {/* Ambient glow */}
              ...
              <div className="relative flex items-center justify-between border-b border-white/[0.08] bg-white/[0.02] p-4 backdrop-blur-sm">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-sm font-extrabold tracking-tight text-white sm:text-base">
