...
export const BET_TYPE_HUBS: BetTypeHub[] = [
  {
    ...
    faqs: {
      en: [
        ...
        {
          q: "Is BTTS a +EV market for casual bettors?",
  ...
  },
  {
    ...
    faqs: {
      en: [
        ...
        {
          q: "Are late-goal swings a problem for Over 2.5 bettors?",
    ...
    faqs: {
      en: [
        ...
        },
        {
          ...
          a: "Yes — but 'safer' usually means 'lower return'. Double Chance compresses the win rate but also compresses the price. Long-term yield for a disciplined DC bettor is usually similar to a disciplined 1X2 bettor, but the variance is much lower. That makes DC popular with bankroll-conscious players.",
        },
        {
      ...
      nl: [
        ...
        },
        {
          ...
          a: "Je kunt geen grote inzetten 'opbouwen' zoals bij rauwe 1X2. Een 1X-weddenschap op 1.20 zet 83% van je stake op het spel om 17% te winnen — dat betekent dat je ~85% hitpercentage nodig hebt om na marge break-even te zijn. Eén slechte week met verrassende uitslagen kan een volle maand stabiele DC-winsten uitvegen.",
        },
        {
  ...
  },
  {
    ...
    faqs: {
      ...
      nl: [
        {
          q: "Wat gebeurt er met mijn DNB-weddenschap bij gelijkspel?",
          a: "Je stake wordt volledig terugbetaald. Je wint noch verliest — de weddenschap wordt ongedaan gemaakt en je geld gaat terug naar je account. Dit is de 'verzekering' die DNB onderscheidt van een rauwe 1X2-weddenschap.",
        },
        {
        ...
        {
          q: "Wanneer is DNB beter dan een rauwe 1X2-weddenschap?",
