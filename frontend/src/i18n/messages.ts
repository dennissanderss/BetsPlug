...
const en = {
  ...
  "pred.noUpcomingMatchesDesc": "No scheduled fixtures were found for this day. Pick another day with the date picker above.",
...
const nl: Dictionary = {
  ...
  "pred.noUpcomingMatchesDesc": "Er zijn geen geplande wedstrijden gevonden voor deze dag. Kies een andere dag met de datumkiezer hierboven.",
