...
const en = {
  ...
  "pricing.bronzeF2": "Based on collected data: 70%+ accuracy on Gold picks",
  ...
  "pricing.silverF1": "Silver picks · top 14 leagues · based on collected data: 60%+ accuracy",
  "pricing.silverF2": "⬜ Free picks included, ~6 picks per day",
  "pricing.silverF3": "Live scores & weekly performance report",
  "pricing.silverF4": "Full public dataset, downloadable per tier",
  ...
  "pricing.goldF1": "Gold picks · top 10 leagues · based on collected data: 70%+ accuracy",
  "pricing.goldF2": "Pick of the Day — our single highest-confidence pick, daily",
  "pricing.goldF3": "⚪ Silver + ⬜ Free included, ~7 picks per day",
  "pricing.goldF4": "Data Analyst tools (Deep Dive, Explorer, Calibration)",
  "pricing.goldF5": "PDF/CSV/JSON exports of every prediction",
  "pricing.goldF6": "Priority email support (12h target)",
  ...
  "pricing.platPitch": "Unlock 🟢 Platinum elite picks from top-5 leagues (Champions League, Premier League, Eredivisie, Süper Lig, Saudi Pro League) with 80%+ historical accuracy, plus every Gold, Silver and Free pick below. Lifetime price lock.",
  ...
  "pricing.platF1": "Platinum elite picks · top 5 leagues · based on collected data: 80%+ accuracy",
  "pricing.platF2": "Pick of the Day — our single highest-confidence pick, daily",
  "pricing.platF3": "🔵 Gold + ⚪ Silver + ⬜ Free included, every tier",
  "pricing.platF4": "All Data Analyst tools + direct founder email access",
  "pricing.platF5": "Lifetime price lock + early access to every new feature",
...
const nl: Dictionary = {
  ...
  "pricing.bronzeF2": "Uit verzamelde data: 70%+ nauwkeurigheid op Gold picks",
  ...
  "pricing.goldF1": "Gold picks · top 10 competities · uit verzamelde data: 70%+ nauwkeurigheid",
  "pricing.goldF2": "Pick of the Day — onze enige dagelijkse top-voorspelling",
  "pricing.goldF3": "⚪ Silver + ⬜ Free meegeleverd, ~7 picks per dag",
  "pricing.goldF4": "Data Analyst tools (Deep Dive, Explorer, Calibration)",
  "pricing.goldF5": "PDF/CSV/JSON-exports van elke voorspelling",
  "pricing.goldF6": "Prioritaire e-mail-support (12u streef)",
  "pricing.goldF7": "Volledige transparantie, elke pick publiek gelogd",
  ...
  "pricing.platF1": "Platinum elite picks · top 5 competities · uit verzamelde data: 80%+ nauwkeurigheid",
  "pricing.platF2": "Pick of the Day — onze enige dagelijkse top-voorspelling",
  "pricing.platF3": "🔵 Gold + ⚪ Silver + ⬜ Free meegeleverd, elke tier",
  "pricing.platF4": "Alle Data Analyst tools + directe email-toegang tot founder",
  "pricing.platF5": "Levenslange prijsvergrendeling + vroege toegang tot nieuwe functies",
  "pricing.platF6": "Betaal één keer. Geen verlengingen. Ooit.",
  ...
  "pricing.platPitch": "Ontgrendel 🟢 Platinum elite picks uit de top 5 competities (Champions League, Premier League, Eredivisie, Süper Lig, Saudi Pro League) met 80%+ historische nauwkeurigheid, plus elke Gold, Silver en Free pick eronder. Levenslange prijsvergrendeling.",
  ...
  "pricing.silverF1": "Silver picks · top 14 competities · uit verzamelde data: 60%+ nauwkeurigheid",
  "pricing.silverF2": "⬜ Free picks meegeleverd, ~6 picks per dag",
  "pricing.silverF3": "Live scores en wekelijks prestatierapport",
  "pricing.silverF4": "Volledige publieke dataset, per tier te downloaden",
