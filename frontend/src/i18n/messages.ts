...
const en = {
  ...
  "pricing.bronzeF1": "Create an account in seconds — no card, no billing",
  "pricing.bronzeF2": "Browse every upcoming prediction with team, league and result",
  "pricing.bronzeF3": "See which picks were correct or incorrect after kickoff",
  "pricing.bronzeF4": "Pick of the Day visible so you can follow our flagship call",
  "pricing.bronzeF5": "Upgrade any time to unlock odds, stake and simulated returns",
  "pricing.silverTagline": "Mid-tier picks for weekend subscribers",
  "pricing.silverCta": "Start Silver",
  "pricing.silverF1": "Silver-tier picks across our 14 core competitions — model confidence ≥ 60%",
  "pricing.silverF2": "Every pick locked pre-match and stored in our public database",
  "pricing.silverF3": "Live scores + a weekly performance report straight to your inbox",
  "pricing.silverF4": "The full public track-record dataset, downloadable per tier",
  "pricing.silverF5": "Email support with a 48-hour response target",
  "pricing.goldTagline": "Top-10 leagues + Data Analyst tools",
  "pricing.goldCta": "Start Gold",
  "pricing.goldF1": "Gold-tier picks from our 10 tightest competitions — model confidence ≥ 70%",
  "pricing.goldF2": "Pick of the Day — the model's single highest-confidence call, published daily",
  "pricing.goldF3": "Silver + Free picks also unlocked — you see the full tier ladder",
  ...
  "pricing.goldF6": "Priority email support (12h target) + Gold Telegram community (soon)",
  ...
  "pricing.platF1": "Platinum elite picks from our 5 strictest competitions — model confidence ≥ 80%",
  "pricing.platF2": "Pick of the Day — the model's single highest-confidence call, published daily",
  "pricing.platF3": "Gold + Silver + Free picks all unlocked — the entire ladder is yours",
  "pricing.platF4": "Every Data Analyst tool + direct founder email + Private Platinum Telegram (20 seats, soon)",
  "pricing.platF5": "Lifetime price lock + early access to every new feature we ship",
  "pricing.platF6": "One payment. No renewals. No surprises. Ever.",
  ...
  "pricingDeep.goldBestFor": "For serious users who want the Data Analyst tools. 🔵 Gold picks (70%+ accuracy) across 10 top leagues, plus downloadable picks, Match Deep Dive, and fast support.",
  "pricingDeep.goldCta": "Start Gold",

  "pricingDeep.platinumTagline": "Elite picks. Pay once. Keep it forever.",
  "pricingDeep.platinumBestFor": "You want our best picks only. 🟢 Platinum unlocks elite picks from the top-5 competitions (Champions League, Premier League, Eredivisie, Süper Lig, Saudi Pro League) with 80%+ historical accuracy, plus every Gold, Silver and Free pick below it. Lifetime.",
  ...
  "pricingDeep.silverInc2": "⬜ Free picks included, top-14 leagues with confidence ≥55%",
  ...
  "pricingDeep.silverOut2": "🟢 Platinum elite picks (top-5 leagues, 80%+ accuracy)",
  ...
  "pricingDeep.silverOut5": "Gold Telegram community (soon)",
  ...
  "pricingDeep.goldInc6": "Priority email support (12h target) + Gold Telegram community (soon)",
  "pricingDeep.goldInc7": "Priority support (12-hour SLA)",
  "pricingDeep.goldInc8": "Full transparency, every pick publicly logged",
  "pricingDeep.goldOut1": "🟢 Platinum elite picks (top-5 leagues, 80%+ accuracy)",
  "pricingDeep.goldOut2": "Lifetime pricing lock",
  "pricingDeep.goldOut3": "Founder-tier perks",

  "pricingDeep.platinumInc1": "🟢 Platinum elite picks, top-5 leagues, confidence ≥75%, 80%+ historical accuracy",
  ...
  "pricingDeep.platinumInc5": "Direct founder email + Private Platinum Telegram (max 20 seats, soon)",
...
const nl: Dictionary = {
  ...
  "pricing.bronzeF1": "Gratis account aanmaken in enkele seconden — geen kaart, geen facturatie",
  "pricing.bronzeF2": "Bekijk elke aankomende voorspelling met team, competitie en resultaat",
  "pricing.bronzeF3": "Zie welke picks correct of incorrect waren na afloop",
  "pricing.bronzeF4": "Pick of the Day zichtbaar zodat je onze vlaggenschip-tip kunt volgen",
  ...
  "pricing.goldF1": "Gold-tier picks uit onze 10 strengste competities — modelbetrouwbaarheid ≥ 70%",
  "pricing.goldF2": "Pick of the Day — dagelijks onze hoogst-scorende pick van de dag",
  "pricing.goldF3": "Silver + Free picks ook ontgrendeld — je ziet de volledige tier-ladder",
  "pricing.goldF4": "Data Analyst tools: Deep Dive, Predictions Explorer, Calibration-view",
  "pricing.goldF5": "PDF / CSV / JSON-export op elke voorspelling in je dashboard",
  "pricing.goldF6": "Prioritaire e-mailondersteuning (12u streef) + Gold Telegram-community (binnenkort)",
  ...
  "pricing.platF1": "Platinum elite picks uit onze 5 strengste competities — modelbetrouwbaarheid ≥ 80%",
  "pricing.platF2": "Pick of the Day — dagelijks onze hoogst-scorende pick van de dag",
  "pricing.platF3": "Gold + Silver + Free picks allemaal ontgrendeld — de hele ladder is van jou",
  ...
  "pricing.silverF1": "Silver-tier picks uit onze 14 kern-competities — modelbetrouwbaarheid ≥ 60%",
  "pricing.silverF2": "Elke pick pre-match vastgezet en opgeslagen in onze publieke database",
  "pricing.silverF3": "Live scores + een wekelijks prestatierapport in je inbox",
  "pricing.silverF4": "De volledige publieke trackrecord-dataset, downloadbaar per tier",
  "pricing.silverF5": "E-mailondersteuning met 48-uur reactietermijn",
  ...
  "pricingDeep.goldBestFor": "Voor serieuze abonnees die de Data Analyst tools willen. 🔵 Gold picks (70%+ nauwkeurigheid) in 10 topcompetities, plus downloadbare picks, Match Deep Dive en snelle support.",
  "pricingDeep.goldCta": "Start Gold",
  ...
  "pricingDeep.goldInc6": "Prioritaire e-mail-support (12u streef) + Gold Telegram-community (binnenkort)",
  ...
  "pricingDeep.goldOut1": "🟢 Platinum elite picks (top-5 competities, 80%+ nauwkeurigheid)",
  ...
  "pricingDeep.planPrefix": "Plan ·",
  "pricingDeep.platinumBestFor": "Je wilt alleen onze beste picks. 🟢 Platinum ontgrendelt elite picks uit de top-5 competities (Champions League, Premier League, Eredivisie, Süper Lig, Saudi Pro League) met 80%+ historische nauwkeurigheid, plus elke Gold, Silver en Free pick eronder. Levenslang.",
  "pricingDeep.platinumCta": "Claim levenslang",
  "pricingDeep.platinumInc1": "🟢 Platinum elite picks, top-5 competities, confidence ≥75%, 80%+ historische nauwkeurigheid",
  ...
  "pricingDeep.platinumInc5": "Directe founder-e-mail + Private Platinum Telegram (max 20 plekken, binnenkort)",
  ...
  "pricingDeep.silverInc2": "⬜ Free picks meegeleverd, top-14 competities met confidence ≥55%",
  ...
  "pricingDeep.silverOut2": "🟢 Platinum elite picks (top-5 competities, 80%+ nauwkeurigheid)",
  "pricingDeep.silverOut3": "Data Analyst tools (Deep Dive, Explorer, Calibration)",
  "pricingDeep.silverOut4": "PDF / CSV / JSON rapport-exports",
  "pricingDeep.silverOut5": "Gold Telegram-community (binnenkort)",
  "pricingDeep.silverTagline": "Het plan voor de weekend-gebruiker",
