...
const nl: Dictionary = {
  ...
  "tier.titleLine1": "Hoger vertrouwen =",
  "tier.titleHighlight": "hogere nauwkeurigheid",
  "tier.lede": "Elke voorspelling krijgt een tier op basis van modelbetrouwbaarheid. Hoe hoger de tier, hoe strenger de drempel en hoe scherper de cijfers.",
  "tier.premiumTier": "Premium tier",
  "tier.liveNote": "Live cijfers, rechtstreeks uit onze database.",
  "tier.seeFullTrackRecord": "Bekijk volledig trackrecord",
  "tier.decimalSep": ",",
