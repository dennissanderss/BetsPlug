...
const en = {
  ...
  "results.roiCalcCi": "Likely range",
  "results.roiCalcCiTooltip": "Because we have only graded a small number of picks so far, the true long-term accuracy isn't pinned down yet. This range is where the real number most likely lies (with 95% confidence) given the current sample. The fewer picks, the wider the range.",
  "results.roiCalcSmallSampleTitle": "Small sample",
  "results.roiCalcSmallSampleHint": "Only {n} graded picks — early streaks are noisy and a single run of losses can wipe out returns even when the long-term model accuracy is high. The likely range above shows how wide the real accuracy could still realistically be. Wait for n ≥ 30 before drawing conclusions.",
...
const nl: Dictionary = {
  ...
  "results.roiCalcBreakEven": "Break-even",
  "results.roiCalcCi": "Waarschijnlijke range",
  "results.roiCalcCiTooltip": "Omdat we pas een klein aantal picks hebben beoordeeld, staat de echte lange-termijn accuratesse nog niet vast. Deze range laat zien waar het werkelijke getal waarschijnlijk ligt (met 95% zekerheid) gegeven de huidige sample. Hoe minder picks, hoe breder de range.",
  "results.roiCalcSmallSampleTitle": "Kleine sample",
  "results.roiCalcSmallSampleHint": "Slechts {n} beoordeelde picks — vroege reeksen zijn ruisig en een enkele verliesreeks kan het rendement tenietdoen, zelfs als de lange-termijn modelaccuraatheid hoog is. De waarschijnlijke range hierboven laat zien hoe breed de echte accuratesse nog kan liggen. Wacht op n ≥ 30 voor conclusies.",
