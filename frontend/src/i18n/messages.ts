...
const nl: Dictionary = {
  ...
  "articles.ctaNoCard": "Symbolische € 0,01 om je proefperiode van 7 dagen te activeren",
  "articles.ctaSubtitle": "Ontvang live AI-kansen, Keuze van de Dag en de volledige BetsPlug Pulse-uitvoer - 7 dagen gratis.",
  ...
  "faq.home.a1": "Een AI-voetbalvoorspellingsplatform gebruikt machine-learning-modellen, historische data en statistische engines (zoals Elo en Poisson) om de meest waarschijnlijke uitkomst van voetbalwedstrijden te voorspellen. BetsPlug is gebouwd als een zuiver analysetool - wij tonen je de cijfers, kansen en expected value, zodat jij kunt bepalen welke weddenschappen je plaatst bij de bookmaker van je keuze.",
  ...
  "faq.home.a3": "Onze AI-voorspeller richt zich uitsluitend op voetbal en dekt de Premier League, La Liga, Serie A, Bundesliga, Ligue 1, Eredivisie, Champions League en meer. Nieuwe voetbalcompetities worden regelmatig toegevoegd naarmate onze modellen getraind en gevalideerd zijn.",
  ...
  "faq.home.a5": "We combineren Elo-ratings, Poisson-doelpuntmodellen en machine-learning-classifiers getraind op honderdduizenden historische wedstrijden. Elke voorspelling bevat de winkans, expected goals, confidence-score en de edge ten opzichte van de huidige bookmakerlijn.",
  ...
  "finalCta.subtitle": "Meer dan 1.500 gokkers in heel Europa gebruiken BetsPlug al om waarde te vinden voordat de markt dat doet. 7 volledige dagen toegang tot Goud – elke voorspelling, de Keuze van de Dag, het volledige trackrecord – voor één symbolische cent. Annuleer met twee klikken als het niets voor je is.",
  ...
  "hero.usp3Desc": "Premier League, La Liga, Bundesliga, Serie A, Champions League en meer — alles in één abonnement.",
  ...
  "how.step2Desc": "Pick of the Day is onze meest betrouwbare AI-voetbalvoorspelling uit meer dan 50 wedstrijden die dag — momenteel met een nauwkeurigheid van {potdAccuracy}% ten opzichte van {potdPicks} keuzes. Eén duidelijke oproep. Dagelijks geleverd. Gratis te zien op de homepage voordat je een cent betaalt.",
  ...
  "how.subtitle": "Eén AI-motor. Eén dagelijkse Keuze van de Dag. Eén publiek verifieerbaar trackrecord. Geen zwarte dozen.",
  ...
  "pricing.bronzeF3": "Dagelijkse keuze van de dag ({potdAccuracy}% nauwkeurigheid)",
  "pricing.bronzeF4": "Trackrecord + resultaten + exporten",
  "pricing.bronzeF5": "Slechts € 0,01 · Annuleer op elk gewenst moment",
  "pricing.bronzeTagline": "Proefversie met volledige toegang voor slechts € 0,01",
  ...
  "pricing.goldF1": "Dagelijkse keuze van de dag ({potdAccuracy}% nauwkeurigheid)",
  "pricing.goldF2": "Alle 30+ competities wereldwijd (CL, UEL, MLS...)",
  "pricing.goldF3": "Exporteren van PDF/CSV/JSON-rapporten",
  "pricing.goldF4": "Exclusieve Gold Telegram-community",
  "pricing.goldF5": "Prioritaire ondersteuning (12u)",
  "pricing.goldF6": "Toegang tot Strategy Lab (binnenkort beschikbaar)",
  ...
  "pricing.platF1": "Lifetime Gold — elke huidige en toekomstige functie",
  "pricing.platF2": "Betaal nooit meer. Geen verlengingen. Ooit.",
  "pricing.platF3": "Private Platinum Telegram (max. 20 zitplaatsen)",
  "pricing.platF4": "Vroege toegang tot alle nieuwe functies",
  "pricing.platF5": "Levenslange prijsvergrendeling – immuun voor toekomstige prijsstijgingen",
  ...
  "pricing.platPitch": "Betaal één keer, ontgrendel elke huidige en toekomstige Gold-functie - plus exclusieve toegang tot Strategy Lab wanneer deze wordt gelanceerd.",
  "pricing.platTagline": "Levenslange toegang. Voordelen op het niveau van de oprichter.",
  ...
  "pricing.silverF2": "Live scores en wedstrijdkansen",
  "pricing.silverF3": "Resultaten en wekelijkse prestatierapporten",
  "pricing.silverF4": "Trackrecord met volledige transparantie",
  "pricing.silverF5": "E-mailondersteuning (48 uur antwoord)",
  "pricing.silverTagline": "Perfect om aan de slag te gaan",
  "pricing.subtitle": "Eén enkele inzet die je op onderbuikgevoel verliest, kost meer dan een maand BetsPlug. Bekijk elke AI-voetbalvoorspelling, de Keuze van de Dag en het volledige openbare trackrecord. Begin met een proefperiode van 7 dagen voor € 0,01. Annuleer met twee klikken als het niets voor jou is. Geen lock-in. Geen verborgen kosten.",
  ...
  "riskReversal.noCardDesc": "Wilt je het model zien voordat je iets betaalt? De Keuze van de Dag en de keuzes van de startpagina van vandaag zijn gratis te bekijken. Geen aanmelding. Geen creditcard.",
  ...
  "track.desc2": "Premier League-voorspellingen, La Liga-tips, Champions League-voorspellingen, Eredivisie-analyse – dezelfde methodologie en dezelfde transparantie in meer dan 30 voetbalcompetities wereldwijd. Geen 'we volgen alleen onze beste competitie'-trucs.",
  ...
  "contact.card2Desc": "Meer dan 1.200 gokkers online, dagelijkse AI-keuzes, live vraag- en antwoordsessies met het modelteam en directe waarschuwingen wanneer het ensemble een wedstrijd met veel vertrouwen markeert.",
  ...
  "contact.faq1A": "BetsPlug is een AI-voetbalanalyseplatform. We publiceren op waarschijnlijkheid gebaseerde voorspellingen uit een ensemble van vier modellen, point-in-time Elo-beoordelingen, Dixon-Coles Poisson-output en een transparant openbaar trackrecord - zodat je op gegevens gebaseerde beslissingen kunt nemen. Wij zijn geen bookmaker; Je kunt bij ons geen weddenschappen plaatsen.",
  ...
  "contact.faq3A": "Meer dan 30 topvoetbalcompetities wereldwijd: Premier League, La Liga, Serie A, Bundesliga, Ligue 1, Eredivisie, UEFA Champions League, Europa League en nog 22+ meer. Elke competitie heeft meer dan 5 seizoenen aan schone trainingsgegevens voordat deze live gaat.",
  ...
  "contact.faq6A": "Ja. Alle betalingen lopen via Stripe, PCI-DSS-compatibel met 256-bit SSL-codering. We zien of bewaren je kaartgegevens nooit op onze servers – Stripe houdt het token vast, wij bewaren niets.",
  ...
  "chatbot.footer": "AI-assistent gebaseerd op BetsPlug-documentatie - voor al het andere kunt je een e-mail sturen naar support@betsplug.com",
  ...
  "chatbot.replyTelegram": "Onze Telegram-gemeenschap heeft meer dan 1.200 actieve leden met dagelijkse keuzes, edge-alerts en live vraag-en-antwoordsessies met onze analisten. Meld je aan via t.me/betsplug - gratis voor Bronze-gebruikers, VIP-kanalen voor Silver/Gold.",
  ...
  "about.missionBody1": "De markt voor voetbalvoorspellingen heeft te lang op hypes gefunctioneerd. YouTube-goeroes jagen op macht. Telegramkanalen die 'sloten van de week' verkopen. Betaalde tipgevers zonder verifieerbare geschiedenis en de gewoonte om slechte maanden te verwijderen. Als levenslange voetbalfans dreef het ons tegen de muur – omdat we wisten dat de onderliggende gegevens al iets interessanters zeiden dan al die gegevens.",
  "about.missionBody2": "Dus hebben we de tool gebouwd waarvan we altijd al wilden dat die bestond: een platform dat duizenden matches per week verwerkt, deze door XGBoost, Dixon-Coles Poisson, point-in-time Elo en een gekalibreerde logistieke regressie laat lopen, en alleen de keuzes publiceert waar de modellen en de markt het oneens zijn genoeg om er toe te doen. Geen vibraties. Geen overlevingsvooroordeel. Elke voorspelling kreeg een tijdstempel vóór de aftrap en werd publiekelijk beoordeeld.",
  ...
  "about.value1Desc": "Elke voorspelling komt voort uit een model, niet uit een stemming. We publiceren de expliciete waarschijnlijkheid, het ensemblevertrouwen en het meningsverschil met de markt, zodat je de redenering kunt verifiëren in plaats van een gezicht op een scherm te vertrouwen.",
  ...
  "about.value3Desc": "Voetbal evolueert. Managers worden ontslagen, roosters worden herschikt en nieuwe competities komen in beeld. Onze modellen worden opnieuw getraind op basis van nieuwe resultaten en het ensemble wordt elk kwartaal opnieuw gewogen op basis van prestaties die buiten de steekproef vallen - nooit stagnerend.",
  ...
  "about.founder1Bio": "Levenslange voetbalfan met tien jaar ervaring in software-engineering. Is eigenaar van het platform end-to-end – opnamepijplijnen, dashboard, Stripe-integratie – en zorgt ervoor dat gegevens netjes van de officiële feeds naar de voorspelling op je scherm stromen.",
  "about.founder2Bio": "Voetballiefhebber werd datawetenschapper met jaren in de ICT-loopgraven. Is eigenaar van het ensemble met vier modellen, walk-forward-validatie, kalibratie en de integriteitsregels die de gepubliceerde winstpercentages eerlijk houden.",
  ...
  "hiw.faq5A": "Met Strategy Lab kunt je voorspellingen filteren op basis van backtested-strategieën (bijvoorbeeld: thuisfavorieten bij regen, underdogs na Europese uitstapjes). Momenteel gemarkeerd als 'Coming Soon', terwijl we de plausibiliteitspoort afronden die voorkomt dat overfit-strategieën als winstgevend worden gepresenteerd.",
  ...
  "checkout.pageSubtitle": "Eén kaartverificatie van € 0,01, daarna volledige toegang tot het ensemble met 4 modellen in meer dan 30 competities. Streepveilig afrekenen, annuleren in twee klikken.",
  "checkout.yearlySaveCallout": "Schakel over naar jaarlijkse facturering en bespaar 20%: dat is elk jaar een korting van {amount}.",
  ...
  "checkout.trialOption1Desc": "Volledige toegang gedurende 7 dagen. Er wordt vandaag niets in rekening gebracht – Stripe verifieert alleen je kaart. Eerste afschrijving op {date} als je niet annuleert.",
  ...
  "checkout.trialPaymentNote": "Er wordt vandaag niets in rekening gebracht. Stripe verifieert je kaart zodat we je abonnement op {date} kunnen starten. Als je vóór die tijd annuleert, worden er geen kosten in rekening gebracht.",
  ...
  "matchPred.metaDesc": "Bekijk de AI-voetbalvoorspellingen van vandaag voor de Premier League, La Liga, Bundesliga en nog 27 andere competities – elke dag drie volledige keuzes gratis, ontgrendeld met een proefperiode van € 0,01.",
  "matchPred.subtitle": "Een live venster van wat het BetsPlug-ensemble op dit moment voorspelt. Drie volledige keuzes zijn elke dag gratis – inclusief winstkansen, betrouwbaarheidsscores en modeluitvoer. Ontgrendel de rest met een proefperiode van € 0,01.",
  ...
  "matchPred.bannerDesc": "Elke vergrendelde keuze hierboven is een volledige voorspelling: waarschijnlijkheden, vertrouwen, ensemble-redenering. Een Bronze-proefversie van € 0,01 ontgrendelt alles gedurende 7 dagen.",
  ...
  "b2b.subtitle": "Sportsbooks, analyseplatforms, mediabedrijven en SaaS-operators gebruiken de BetsPlug-engine – ruwe waarschijnlijkheden, grootboek, ensemble-uitvoer – om pre-match odds, redactionele inzichten en gebruikersgerichte voorspellingen aan te sturen. Vier samenwerkingssporen, één onderliggend model.",
  ...
  "b2b.dataLicensingDesc": "Directe API-toegang tot AI-voetbalvoorspellingen, ensemblekansen, point-in-time Elo-beoordelingen en wedstrijdfuncties. Perfect voor sportsbooks, fantasyplatforms en kwantitatief georiënteerde analyseproducten.",
