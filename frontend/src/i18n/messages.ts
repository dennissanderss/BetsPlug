...
const en = {
  ...
  "results.roiCalcIntro": "Follow the four steps to see what our past picks would have returned at your own stake.",
...
const nl: Dictionary = {
  ...
  "results.roiCalcIntro": "Doorloop de vier stappen om te zien wat onze eerdere tips zouden hebben opgeleverd bij jouw inzet.",
