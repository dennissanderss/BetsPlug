...
const en = {
  ...
  "pricing.bronzeF1": "Seven days of full Gold access — no commitment",
  "pricing.bronzeF2": "See the Gold tier's historical track record live before you decide",
  "pricing.bronzeF3": "Every pick clearly labelled Free / Silver / Gold so you learn our system",
  "pricing.bronzeF4": "Match Deep Dive + Predictions Explorer + CSV export included",
  "pricing.bronzeF5": "€0.01 today · cancel any time in one click",
  ...
  "pricingDeep.bronzeInc2": "Based on collected data: 70%+ accuracy on Gold picks",
  ...
  "pricingDeep.bronzeOut1": "🟢 Platinum elite picks (top-5 leagues, 80%+ accuracy)",
  "pricingDeep.bronzeOut2": "Gold Telegram community (soon)",
...
const nl: Dictionary = {
  ...
  "pricing.bronzeF1": "Zeven dagen volledige Gold-toegang zonder verplichting",
  "pricing.bronzeF2": "Bekijk live het historische Gold-trackrecord voordat je beslist",
  "pricing.bronzeF3": "Elke pick duidelijk gelabeld Free / Silver / Gold — zo leer je ons systeem kennen",
  "pricing.bronzeF4": "Match Deep Dive + Predictions Explorer + CSV-export inbegrepen",
  "pricing.bronzeF5": "€ 0,01 vandaag · met één klik opzegbaar",
  ...
  "pricingDeep.bronzeInc2": "Uit verzamelde data: 70%+ nauwkeurigheid op Gold picks",
  "pricingDeep.bronzeInc3": "⚪ Silver + ⬜ Free picks meegeleverd, elke pick met tier-label",
  "pricingDeep.bronzeInc4": "Match Deep Dive + Predictions Explorer + CSV-export",
  "pricingDeep.bronzeInc5": "Volledige publieke dataset, per tier te downloaden",
  "pricingDeep.bronzeInc6": "Annuleer met twee kliks, geen automatische upgrade",
  "pricingDeep.bronzeOut1": "🟢 Platinum elite picks (top-5 competities, 80%+ nauwkeurigheid)",
  "pricingDeep.bronzeOut2": "Gold Telegram-community (binnenkort)",
