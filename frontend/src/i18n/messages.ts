...
const en = {
  ...
  "hero.ctaPrimary": "Claim Your Edge — Unlock Now",
...
const nl: Dictionary = {
  ...
  "hero.ctaPrimary": "Claim jouw voorsprong — Start nu",
...
const de: Dictionary = {
  ...
  "hero.ctaPrimary": "Sichere dir deinen Vorteil — Jetzt starten",
...
const fr: Dictionary = {
  ...
  "hero.ctaPrimary": "Prenez l'avantage — Commencez maintenant",
...
const es: Dictionary = {
  ...
  "hero.ctaPrimary": "Consigue tu ventaja — Empieza ya",
...
const it: Dictionary = {
  ...
  "hero.ctaPrimary": "Prendi il vantaggio — Inizia ora",
...
const sw: Dictionary = {
  ...
  "hero.ctaPrimary": "Pata faida yako — Anza sasa",
...
const id: Dictionary = {
  ...
  "hero.ctaPrimary": "Raih keunggulanmu — Mulai sekarang",
