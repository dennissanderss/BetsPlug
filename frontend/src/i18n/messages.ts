...
const en = {
  ...
  "results.roiCalcCi": "95% CI",
  "results.roiCalcSmallSampleTitle": "Small sample",
  "results.roiCalcSmallSampleHint": "Only {n} graded picks — early streaks are noisy and a single run of losses can wipe out returns even when the long-term model accuracy is high. The 95% CI shows how wide the true accuracy could still realistically be. Wait for n ≥ 30 before drawing conclusions.",
...
const nl: Dictionary = {
  ...
  "results.roiCalcBreakEven": "Break-even",
  "results.roiCalcCi": "95% BI",
  "results.roiCalcSmallSampleTitle": "Kleine sample",
  "results.roiCalcSmallSampleHint": "Slechts {n} beoordeelde picks — vroege reeksen zijn ruisig en een enkele verliesreeks kan het rendement tenietdoen, zelfs als de lange-termijn modelaccuraatheid hoog is. Het 95%-BI laat zien hoe breed de echte accuraatheid nog kan liggen. Wacht op n ≥ 30 voor conclusies.",
