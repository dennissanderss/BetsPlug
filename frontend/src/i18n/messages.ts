...
const en = {
  ...
  "articles.ctaSubtitle": "Create a free account and get match-by-match win probabilities, the public track record, and a clear path to upgrade once you want odds and the simulator.",
  "articles.ctaButton": "Create free account",
  ...
  "articles.listCtaPrimary": "Create free account",
...
const nl: Dictionary = {
  ...
  "articles.ctaSubtitle": "Maak een gratis account en ontvang wedstrijd-per-wedstrijd winstkansen, het publieke trackrecord, en een duidelijk pad om te upgraden zodra je odds en de simulator wilt.",
  ...
  "articles.listCtaPrimary": "Maak gratis account",
  ...
  "articles.subtitle": "Wedstrijduitsplitsingen, deep-dives van modellen en datagestuurde data-inzichten - geschreven door het team achter de BetsPlug AI-voetbalvoorspellingsengine.",
