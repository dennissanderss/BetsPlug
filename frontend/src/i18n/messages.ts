...
const en = {
  ...
  "pricing.silverTagline": "Daily picks for smart analysts",
  "pricing.silverCta": "Start Silver",
  "pricing.silverF1": "Daily Pick of the Day (66.7% accuracy)",
  "pricing.silverF2": "Top 5 European leagues predictions",
  ...
  "pricing.goldTagline": "Full access. Every league. Every tool.",
  "pricing.goldCta": "Start Gold",
  "pricing.goldF1": "All 30+ leagues worldwide (CL, UEL, MLS…)",
  "pricing.goldF2": "All predictions with live scores & odds",
  "pricing.goldF3": "Daily Pick of the Day + instant alerts",
  "pricing.goldF4": "PDF/CSV/JSON report exports",
  "pricing.goldF5": "Exclusive Gold Telegram community",
  "pricing.goldF6": "Priority support (12h) + Strategy Lab (coming soon)",
  ...
  "pricing.platF2": "First access to Strategy Lab (build custom strategies)",
  "pricing.platF3": "Private Platinum Telegram (max 20 seats)",
  "pricing.platF4": "1-on-1 onboarding call with our founders",
...
const nl: Dictionary = {
  ...
  "pricing.silverTagline": "Dagelijkse picks voor slimme analisten",
  "pricing.silverCta": "Start Silver",
  "pricing.silverF1": "Dagelijkse Pick van de Dag (66,7% trefzekerheid)",
  "pricing.silverF2": "Top 5 Europese competities voorspellingen",
  ...
  "pricing.goldTagline": "Volledige toegang. Elke competitie. Elk tool.",
  "pricing.goldCta": "Start Gold",
  "pricing.goldF1": "Alle 30+ competities wereldwijd (CL, UEL, MLS…)",
  "pricing.goldF2": "Alle voorspellingen met live scores & odds",
  "pricing.goldF3": "Dagelijkse Pick van de Dag + directe meldingen",
  "pricing.goldF4": "PDF/CSV/JSON rapport-exports",
  "pricing.goldF5": "Exclusief Gold Telegram community",
  "pricing.goldF6": "Prioriteitsupport (12u) + Strategy Lab (binnenkort)",
  ...
  "pricing.platPitch": "Betaal één keer, ontgrendel elke huidige en toekomstige Gold-functie — plus als eerste toegang tot Strategy Lab.",
  ...
  "pricing.platF2": "Eerste toegang tot Strategy Lab (eigen strategieën bouwen)",
  "pricing.platF3": "Privé Platinum Telegram (max 20 plekken)",
  "pricing.platF4": "1-op-1 onboarding met onze oprichters",
