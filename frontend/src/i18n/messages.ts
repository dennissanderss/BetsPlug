...
const en = {
  ...
  "route.subtitle": "BetsPlug Pulse analyses every match. Choose how you want to use the results.",
  "route.botdTitle": "Pick of the Day",
  "route.botdBadge": "#1 Recommendation",
  "route.botdDesc": "Every day, Pulse automatically selects the match the model is most confident about. One pick, maximum conviction.",
  "route.botdAccuracy": "Accuracy",
  "route.botdPicks": "Picks",
  "route.botdStreak": "Streak",
  "route.predictionsTitle": "All Predictions",
  "route.predictionsBadge": "Live + Upcoming",
  "route.predictionsDesc": "View all matches with AI analysis, live scores, odds and probability calculations. Filter by league and sort by confidence.",
  "route.predictionsPredicted": "Predicted",
  "route.predictionsAccuracy": "Accuracy",
  "route.strategyLabTitle": "Strategy Lab",
  "route.strategyLabBadge": "Coming Soon",
  "route.strategyLabDesc": "Build your own strategy with filters on confidence, league and market. We're collecting data to validate this fairly and transparently.",
  "route.performanceTitle": "Performance & Overview",
  "route.commonResults": "Results",
  "route.commonResultsDesc": "See outcomes of all predictions",
...
const nl: Dictionary = {
  ...
  "route.subtitle": "BetsPlug Pulse analyseert elke wedstrijd. Kies hoe je de resultaten wilt gebruiken.",
  "route.botdTitle": "Pick van de Dag",
  "route.botdBadge": "#1 Aanbeveling",
  "route.botdDesc": "Elke dag selecteert Pulse automatisch de wedstrijd waar het model het meest zeker van is. Eén pick, maximale overtuiging.",
  "route.botdAccuracy": "Trefzekerheid",
  "route.botdPicks": "Picks",
  "route.botdStreak": "Reeks",
  "route.predictionsTitle": "Alle Voorspellingen",
  "route.predictionsBadge": "Live + Komend",
  "route.predictionsDesc": "Bekijk alle wedstrijden met AI-analyse, live scores, odds en kansberekeningen. Filter per competitie en sorteer op zekerheid.",
  "route.predictionsPredicted": "Voorspeld",
  "route.predictionsAccuracy": "Nauwkeurigheid",
  "route.strategyLabTitle": "Strategy Lab",
  "route.strategyLabBadge": "Binnenkort",
  "route.strategyLabDesc": "Bouw je eigen strategie met filters op zekerheid, competitie en markt. We verzamelen data om dit eerlijk en transparant te valideren.",
  "route.performanceTitle": "Prestaties & Overzicht",
  "route.commonResults": "Resultaten",
  "route.commonResultsDesc": "Bekijk uitslagen van alle voorspellingen",
