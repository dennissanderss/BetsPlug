...
const en = {
  ...
  "pricing.subtitle":
    "Most subscribers burn through €15 in a single weekend on gut-feeling stakes. BetsPlug gives you AI football predictions, a daily Pick of the Day, and a fully public track record, for less than that one lost accumulator. Try it for €0.01 over 7 days. Cancel in two clicks. No lock-in. No hidden fees.",
  ...
  "about.ctaSubtitle":
    "Join 1,500+ users who get every AI pick, every probability, and every grade, published before the closing line moves. Seven-day Gold trial for €0,01, cancel in two clicks.",
  ...
  "recognize.answerPrice": "3 picks per day free. €0.01 trial.",
...
const nl: Dictionary = {
  ...
  "about.ctaSubtitle": "Sluit je aan bij meer dan 1.500 abonnees die elke AI-keuze, elke kans en elk cijfer krijgen, gepubliceerd voordat de slotlijn beweegt. Gold-proefperiode van zeven dagen voor € 0,01, opzeggen in twee klikken.",
  ...
  "matchPred.subtitle": "Kijk wat de AI van BetsPlug momenteel voorspelt. Drie volledige keuzes zijn elke dag gratis, inclusief winstkansen, betrouwbaarheidsscores en aanbevolen voorspellingstypes. Ontgrendel de rest met een proefperiode van € 0,01.",
  ...
  "recognize.answerPrice": "3 picks per dag gratis. €0,01 trial.",
