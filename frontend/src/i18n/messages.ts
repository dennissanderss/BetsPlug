...
const nl: Dictionary = {
  ...
  "pricing.bronzeF3": "Dagelijks Pick of the Day ({potdAccuracy}% nauwkeurigheid)",
  ...
  "pricing.goldF1": "Dagelijks Pick of the Day ({potdAccuracy}% nauwkeurigheid)",
  ...
  "pricing.goldF6": "Strategy Lab toegang (binnenkort beschikbaar)",
