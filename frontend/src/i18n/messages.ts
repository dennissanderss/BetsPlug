...
const en = {
  ...
  "pricingDeep.bronzeInc4": "Pick of the Day visible so you can follow the flagship call",
  "pricingDeep.bronzeInc5": "Free Access tier — upgrade only when you want to",
  "pricingDeep.bronzeInc6": "One-click upgrade, no contract",
  "pricingDeep.bronzeOut1": "Bookmaker odds hidden per pick",
  "pricingDeep.bronzeOut2": "No simulated returns or stake calculator",
  "pricingDeep.bronzeOut3": "Silver / Gold / Platinum tier filters locked",
...
const nl: Dictionary = {
  ...
  "pricingDeep.bronzeInc4": "Pick of the Day zichtbaar zodat je de vlaggenschip-tip kunt volgen",
  "pricingDeep.bronzeInc5": "Free Access tier — upgrade pas wanneer jij dat wilt",
  "pricingDeep.bronzeInc6": "Eén klik upgraden, geen contract",
  "pricingDeep.bronzeOut1": "Geen bookmaker-odds zichtbaar per pick",
  "pricingDeep.bronzeOut2": "Geen gesimuleerde rendementen of stake-calculator",
  "pricingDeep.bronzeOut3": "Silver / Gold / Platinum filters staan op slot",
