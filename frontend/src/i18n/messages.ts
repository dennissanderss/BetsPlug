...
const nl: Dictionary = {
  ...
  "faq.pred.a1": "Onze AI analyseert historische data, recente vorm, teamstatistieken en verwachte doelpunten om voor elke wedstrijd kansen te berekenen op thuiswinst, gelijkspel en uitwinst.",
  ...
  "nav.bet_of_the_day": "Pick of the Day",
  "nav.analyst_hub": "Analyst Hub",
  "nav.predictions_explorer": "Voorspellingen-verkenner",
  "nav.match_deep_dive": "Match Deep Dive",
  "nav.engine_performance": "Engine Performance",
  ...
  "seo.pillar1Desc": "BetsPlug Pulse, onze AI-voetbalvoorspellingsengine, combineert meerdere AI-modellen om wedstrijdresultaten in alle grote voetbalcompetities te voorspellen. Meerdere modellen werken samen voor nauwkeurigere voorspellingen — zodat je datagestuurde voetbaltips krijgt waarop je kunt vertrouwen.",
  ...
  "seo.pillar8Desc": "BetsPlug Pulse, onze AI-engine, combineert een teamsterkte-tracker, een doelpuntenvoorspeller en een patroonherkenner — en mixt alle signalen tot definitieve wedstrijdkansen. Het resultaat: nauwkeurige, op data gebaseerde voetbalvoorspellingen die vóór elke speeldag in alle ondersteunde competities worden bijgewerkt.",
  ...
  "hiw.faq2A": "Elke dag selecteert onze AI één wedstrijd met het hoogste vertrouwen. Dat is de Pick of the Day — momenteel met een hitpercentage van {potdAccuracy}%. Je krijgt ook elke andere voorspelling op het platform, niet alleen deze.",
  ...
  "checkout.pageSubtitle": "Eén kaartverificatie van € 0,01, daarna volledige toegang tot alle AI-voorspellingen in meer dan 30 competities. Veilig afrekenen via Stripe, annuleren in twee klikken.",
  ...
  "matchPred.subtitle": "Een live venster van wat onze AI op dit moment voorspelt. Drie volledige picks zijn elke dag gratis — inclusief winkansen en betrouwbaarheidsscores. Ontgrendel de rest met een proefperiode van € 0,01.",
  ...
  "b2b.subtitle": "Sportsbooks, analyseplatforms, mediabedrijven en SaaS-operators gebruiken de BetsPlug-engine — ruwe kansen, volledig trackrecord en AI-output — om pre-match odds, redactionele inzichten en gebruikersgerichte voorspellingen aan te sturen. Vier samenwerkingssporen, één AI-platform.",
